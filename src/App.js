...
import {Button, ListItemText, TextField, Typography, List, ListItem, Dialog, DialogContent, DialogContentText} from '@material-ui/core';
      ...
      <div className="App">
        ...
        <div className="input_area">
          ...
          <Button
            ...
            startIcon={<SaveIcon />}
            style={{float:'right'}}
            onClick={(value)=>console.log(this.state)}
          >
            Save
          </Button>
          <Dialog
        ...
        <Typography variant="body2" color="textSecondary" align="center">
          {'Copyright © 배규리'+new Date().getFullYear()+'.'}
        </Typography>
      </div>
    );
  }
